...
INPUT_ALI = 'CYP_450_alignment.fasta'

chain_id = 'A'

#csv_output = '3czp 1 vs 2'

pdb_list = ['bicC_model1_iTasser.pdb',
			'bicC_model1_robetta_oxyHEM.pdb',
			'bicC_model1_robetta.pdb',
			'desC_model1_robetta.pdb',
			'ktnC_model1_robetta.pdb',

]#'6apg.pdb']

import csv

csv_files = [#'cyp_blosum30_gi0_stats.csv',
			#'cyp_pc_gi0_stats.csv',
